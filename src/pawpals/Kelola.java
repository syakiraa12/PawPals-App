...
public class Kelola extends javax.swing.JFrame {
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "INSERT INTO hewan (nama_hewan, jenis, umur, jenis_kelamin, kondisi_kesehatan) VALUES (?, ?, ?, ?, ?)";
            ...
            ps.setString(4, cbJenisKelamin.getSelectedItem().toString());
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "UPDATE hewan SET nama_hewan=?, jenis=?, umur=?, jenis_kelamin=?, kondisi_kesehatan=? WHERE id_hewan=?";
            ...
            ps.setString(3, txtUmur.getText());
            ps.setString(4, cbJenisKelamin.getSelectedItem().toString());
            ps.setString(5, txtStatus.getText()); // Kondisi Kesehatan -> TxtStatus
            ps.setString(6, txtIdHewan.getText()); // ID untuk target update
    ...
    private void tblHewanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblHewanMouseClicked
        ...
        if (row != -1) {
            ...
            txtUmur.setText(tblHewan.getValueAt(row, 3).toString());
            txtStatus.setText(tblHewan.getValueAt(row, 5).toString());
        }
